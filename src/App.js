import logo from './imagens/assespro.png';
...
import logo_ac7 from './imagens/logo-ac7.png'
import './App.css';
...
function App() {
  return (
    <div className="App">
      ...
      <div className = "div-logo-ac7">
        <header className = "teste-logo1"></header>
        <main className = "teste-logo2"><img src={logo_ac7} className="App-logo-ac7" alt="logo-ac7" /></main>
      </div>
